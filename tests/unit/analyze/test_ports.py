...
def test_dedup_per_port_proto_comm() -> None:
    events: list[dict[str, object]] = [
        {"family": 2, "port": 8443, "proto": "tcp", "comm": "example-app"},
        {"family": 2, "port": 8443, "proto": "tcp", "comm": "example-app"},  # dup
        {"family": 10, "port": 8443, "proto": "tcp", "comm": "example-app"},  # v6 same comm
    ]
