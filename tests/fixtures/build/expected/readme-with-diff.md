...
The generated container was rebuilt and exercised under strict policy. These entries appeared in the verify trace but not the original:

| Category | Count | Details |
|---|---|---|
| New paths | 1 | `/etc/foo` |
| New ports | 0 | - |
| New caps | 1 | `CAP_SYS_CHROOT` |
| New syscalls | 1 | 437 |
| New execs | 0 | - |

Full diff: see `verify.json`.
